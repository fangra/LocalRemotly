...
IF %WData%==y ( set /p WOData=Do you want to Export Data from a source org or use your files ? [s/f]: ) 
...
call sfdx force:org:create  --setdefaultusername -f config/project-scratch-def.json -a my-scratch --setalias %sorg%
